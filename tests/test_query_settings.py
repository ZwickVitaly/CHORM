...
class TestQuerySettings:
    ...
    def test_custom_settings(self):
        ...
        settings = QuerySettings(
            max_threads=4,
            custom={'custom_setting': 'value', 'another_setting': 123}
        )
