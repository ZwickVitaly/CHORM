...
from chorm import Column, MergeTree, Table, create_engine
from chorm.codecs import LZ4, ZSTD, Delta, Gorilla
...
@pytest.fixture(scope="module")
def engine():
    return create_engine(host=HOST, port=PORT, database=DB, username=USER, password=PASSWORD)
